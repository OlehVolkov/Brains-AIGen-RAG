...
from brain.shared.text import _with_warnings, snippet
from brain.sources.vault.models import VaultSearchConfig
from brain.config.loader import resolve_vault_paths
