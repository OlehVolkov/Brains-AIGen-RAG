...
def register_pdf_commands(app: typer.Typer) -> None:
    ...
    def index_command(
        ...
        index_root: Annotated[
            str | None,
            typer.Option(help="Directory under /.brain/.index for search artifacts."),
        ] = None,
    ...
    def fetch_pdfs_command(
        ...
        index_root: Annotated[
            str | None,
            typer.Option(help="Directory under /.brain/.index for fetch manifests and search artifacts."),
        ] = None,
